...
/// Full-featured demo server showcasing prompts, resources, and tools.
/// Not used by default; import it in your own code if you want the
/// batteries-included example experience.
pub fn build() -> server.Server {
  server.new("MCP Toolkit Demo", "1.0.0")
...
pub type TimeRequest {
  TimeRequest(timezone: Option(String))
}
